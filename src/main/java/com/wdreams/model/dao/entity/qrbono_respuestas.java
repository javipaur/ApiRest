...
@Entity
@Table(name = "qrbono_respuestas")
public class qrbono_respuestas implements Serializable {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;

    @JsonIgnore
    @JoinTable(name = "qrbono_peticiones", joinColumns = {
    ...
    public qrbono_respuestas(Integer peticionid, Date caducidad, Integer pax, Date fecha, String servicio,
